...
static const sp_config_keyword sp_func[] = {
    ...
    {parse_enable,              SP_TOKEN_HARDEN_RANDOM, &(SPCFG(random))},
    ...
    {parse_enable,              SP_TOKEN_GLOBAL_STRICT, &(SPCFG(global_strict))},
    ...
    {parse_enable,              SP_TOKEN_XXE_PROTECTION, &(SPCFG(xxe_protection))},
    ...
    {parse_enable,              SP_TOKEN_SLOPPY_COMPARISON, &(SPCFG(sloppy))},
